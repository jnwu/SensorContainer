...
function SceneSetup() {
    ...
    var material1 = new CubicVR.Material({
        textures: {
            color: new CubicVR.Texture("2576-diffuse.jpg"),
            bump: new CubicVR.Texture("2576-bump.jpg")
        }
    });

    var material2 = new CubicVR.Material({
        textures: {
            color: new CubicVR.Texture("2062-diffuse.jpg")
        }
    });

    var material3 = new CubicVR.Material({
        textures: {
            color: new CubicVR.Texture("6583-diffuse.jpg"),
            bump: new CubicVR.Texture("6583-bump.jpg")
        }
    });
